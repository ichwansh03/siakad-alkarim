...
$iubat='Sistem Informasi Akademik SD Negeri 1 Rejomulyo' ;				
        ...
        $pdf->Write(4,'Developed by Ichwan Sholihin & Rama Suherman');
					...
					while($rec = $qry->fetch_assoc())
                     {
						...
						$pdf->SetFont('Times','',8);
						$pdf->Cell(8,20,$sl,1);
						$pdf->Cell(40,20,$rec['nama'],1);
						$pdf->Cell(40,20,$rec['kontak'],1);
