...
<html class="no-js" lang="">
    <head>
        ...
        <meta name="description" content="Dashboard Guru SMP Alam Al-Karim Lampung">
        ...
        <header class="container header_area" >
			<div id="sticker">
				<div class="head">
					...
					<h2>Dashbroad Guru SMP Alam Al-Karim Lampung</h2>
					</div>
				</div>
				<div class="menu ">
					...
					<ul>
						...
						<li><a href="guru_ubah_pw.php"><i class="fa fa-gear" aria-hidden="true"></i> Ubah Password</a></li>
						<li><a href="sw_hasil.php"><i class="fa fa-list" aria-hidden="true"></i> Hasil</a></li>
