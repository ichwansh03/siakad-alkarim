...
<div class="all_student fix">
	<h3 style="text-align:center;color:#fff;margin:0;padding:5px;background:#1abc9c">Kehadiran</h3>
		<div  class="fix" style="background:#ddd;padding:20px;">
			...
			<span style="float:right;"> <button style="background:#58A85D;border:none;color:#fff;padding:10px;"><a style="color:#fff;" href="pres_kelas.php">Ambil Kehadiran</a></button></span>
		</div>
		...
		?>
			<tr>
				...
				<td><a href="pres_single_view.php?dt=<?php echo $rows['at_date']; ?>">Lihat Kehadiran</a></td>
