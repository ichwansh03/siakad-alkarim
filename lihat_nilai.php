...
?>	
<?php 
$pageTitle = "Hasil Penilaian Siswa";
...
<div class="all_student fix">
	...
	<p style='text-align:center;background:#ddd;color:#01C3AA;padding:5px;width:84%;margin:0 auto'>Semua Nilai</p>
	<?php
	//select semester
			$i=0;
			$ch = 0;
			...
			<tr>
				...
				<?php
					...
					if($stat<60){
						...
						echo "<span style='background:yellow'>Remidi</span>";
					}else{
